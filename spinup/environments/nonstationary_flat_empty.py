...
class NonStationaryFlatEmptyEnv(FlatMiniGridEnv):
    ...
    def _gen_grid(self, width, height):
        ...
        if self.episode_num % 1000 == 0 and (self.episode_num // 1000) % 2 == 1:
...
class NonStationaryFlatEmptyEnv5x5(NonStationaryFlatEmptyEnv):
    def __init__(self):
        super().__init__(size=5)


class NonStationaryFlatEmptyRandomEnv5x5(NonStationaryFlatEmptyEnv):
    def __init__(self):
...
class NonStationaryFlatEmptyRandomEnv6x6(NonStationaryFlatEmptyEnv):
    def __init__(self):
